...
viewport.addChild(PIXI.Sprite.from('public/assets/room.png'));
...
function initSocket() {
  ...
  socket.onmessage = async (message) => {
    /* eslint brace-style: "off"
       ---
       Looks nicer this way. Once we start all protocol messages with the
       command, we can use switch instead of if/else to avoid this issue.
    */
